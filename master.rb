...
run 'curl -L https://github.com/thomasvanholder/jumpstart/tree/main/rails-stylesheets-master.zip > stylesheets.zip'
...
gsub_file('app/views/layouts/application.html.erb', "<%= javascript_pack_tag 'application', 'data-turbolinks-track': 'reload' %>", "<%= javascript_pack_tag 'application', 'data-turbolinks-track': 'reload', defer: true %>","<%= stylesheet_pack_tag 'application', 'data-turbolinks-track': 'reload' %>)
style = <<~HTML
